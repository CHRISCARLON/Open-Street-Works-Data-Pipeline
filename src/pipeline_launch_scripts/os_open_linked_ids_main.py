...
def main(batch_limit: int):
    ...
    create_table(conn_road_toid_usrn, schema = "os_open_linked_identifiers", name="os_open_linked_identifiers_toid_usrn_road_latest")
    ...
    create_table(conn=conn_usrn_topo, schema = "os_open_linked_identifiers", name="os_open_linked_identifiers_usrn_topo_area_toid_latest")
