...
class SWACodeModel(BaseModel):
    ...
    registered_for_street_manager: Optional[str] = Field(None, alias="Registered for Street Manager")
    ...
    ofgem_electricity_licence: Optional[str] = Field(None, alias="Ofgem Electricity Licence")
    ...
    swa_code_of_new_company: Optional[str] = Field(None, alias="SWA Code of New Company")
