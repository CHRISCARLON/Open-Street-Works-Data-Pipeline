from src.england_street_manager.historic_main_links import (
    generate_monthly_download_links,
)
...
def test_generate_links_for_all_months_of_2023():
    ...
    assert (
        links_2023[0]
        == "https://opendata.manage-roadworks.service.gov.uk/permit/2023/01.zip"
    )
    assert (
        links_2023[-1]
        == "https://opendata.manage-roadworks.service.gov.uk/permit/2023/12.zip"
    )
...
def test_generate_links_for_specific_range_of_months():
    ...
    assert (
        links_range[0]
        == "https://opendata.manage-roadworks.service.gov.uk/permit/2022/07.zip"
    )
    assert (
        links_range[-1]
        == "https://opendata.manage-roadworks.service.gov.uk/permit/2022/09.zip"
    )
